...
function NavBar() {
  ...
  return (
    ...
    <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 bg-white text-black dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
      sticky?"sticky-navbar shadow-lg bg-slate-300 dark:bg-slate-400 duration-200 transition-all ease-in-out":""
    } `} >
  ...
  <div className="navbar-start wd-50">
    ...
    <a className=" text-2xl font-extrabold cursor-pointer">Book Store</a>
  </div>
...
<label className="swap swap-rotate">
  ...
  <a  className="bg-white text-black dark:bg-black dark:text-white dark:hover:bg-white px-3 py-2 rounded-md hover:bg-black hover:text-white duration-300 cursor:pointer"
